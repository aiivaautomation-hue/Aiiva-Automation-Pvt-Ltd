...
<h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-6">
  AIIVA AUTOMATION PRIVATE LIMITED PRIVACY STATEMENT
</h2>

<p className="mb-6">
  AIIVA AUTOMATION PRIVATE LIMITED, and its subsidiaries or Parent Companies (collectively “AIIVA AUTOMATION PVT. LTD.”) are committed to protecting your privacy and providing you with a positive experience on our websites and in using our products and services (“Solution” or “Solutions”).
</p>
...
<p className="mb-6">
  If you choose to provide AIIVA AUTOMATION PVT. LTD. with a third party’s personal information (such as name, email, and phone number), you represent that you have the third party’s permission to do so. Examples include forwarding reference or marketing material to a friend or sending job referrals. Third parties may unsubscribe from any future communication following the link provided in the initial message. In some instances, AIIVA AUTOMATION PVT. LTD. and the third parties we engage may automatically collect data through cookies, web logs, web beacons, and other similar applications. This information is used to better understand and improve the usability, performance, and effectiveness of the website and to help tailor content or offers for you.
</p>
...
<p className="mb-6">
  We may use your personal information for the purposes…
  <ul className="pl-6 list-disc">
    ...
    <li>Sending communications to you, including for marketing or customer satisfaction purposes, either directly from AIIVA AUTOMATION PVT. LTD. or from our partners.</li>
  </ul>
</p>
...
<p className="mb-6">
  In general, AIIVA AUTOMATION PVT. LTD. may use your Registration Data and/or other information or data we receive or collect, as well as data we derive or infer from combinations of the foregoing, for a variety of purposes, such as:
  <ul className="pl-6 list-disc">
...
<p className="mb-6">
  The Service may share information we receive or collect in a variety of ways, such as: Sharing of Personally Identifiable Information: We do not share personally identifiable information with third parties other than as described in this policy. However, we may share your information, including personally identifiable information, in order to (i) protect or defend the legal rights or property of AIIVA AUTOMATION PVT. LTD., or the legal rights of our business partners, employees, agents, and contractors (including enforcement of our agreements); (ii) protect the safety and security of AIIVA AUTOMATION PVT. LTD. users or members of the public including acting in urgent circumstances; (iii) protect against fraud or to conduct risk management; or (iv) comply with the law, legal process, or legal requests. Additionally, we may share your data, including any personally identifiable information, with our successor in interest in the event of a corporate reorganization, merger, or sale of all or substantially all of our assets.
</p>

<p className="mb-6">
  Sharing of device data: AIIVA AUTOMATION PVT. LTD. may share information from devices you use to access the Service with its advertising and other partners. We share this information for a variety of purposes such as advertising frequency capping, tracking advertising conversion events, estimating the number of unique users, security and fraud detection, targeted advertising, debugging problems with the Service, and for providing you with more relevant advertisements.
</p>

<p className="mb-6">
  Sharing of Anonymised, Non-Personally Identifiable or Aggregated Data: AIIVA AUTOMATION PVT. LTD. may share with third parties, advertisers, and/or business partners anonymised, non-personally identifiable, or aggregated data we receive or collect, such as de-identified Registration Data, Content Data and Device Data. We share such information for a variety of reasons, such as to analyse Service usage, improve the Service, improve the serving of advertisements, or for other purposes. The use and disclosure of such anonymised, non-personally identifiable, or aggregated information is not subject to any restrictions under this policy.
</p>

<p className="mb-6">
  Information You Disclose in a Public Profile or in Public Forums: The AIIVA AUTOMATION PVT. LTD. Service offers publicly accessible and available pages on social media platforms. You should be aware that any information you provide or post in these areas may be read, collected, and used by others who access them. If your profile is public, any information you place in your user profile, including biographical information, the people you are following, and the people whom you allow to follow you, may be read, collected, and used by others who access them. To request removal of such information from our public forums, contact us at aiivaautomation@gmail.com
</p>
...
<p className="mb-6">
  Some AIIVA AUTOMATION PVT. LTD. entities may act as or be considered “data controllers”. When a AIIVA AUTOMATION PVT. LTD. entity is acting as a data controller, you can exercise your rights of access and request corrections, suppression, or deactivations under applicable data protection laws directly with that AIIVA AUTOMATION PVT. LTD. entity by writing to aiivaautomation@gmail.com.
</p>
...
<p className="mb-6">
  By sending us a message through email or by mail to: AIIVA AUTOMATION PRIVATE LIMITED F-504 , The Legend , Basheer bagh , Hyderabad - 500063.
</p>
...
<p className="mb-6">
  These choices do not apply to service notifications or other required communications that are considered part of certain Solutions, which you may receive periodically unless you stop using or cancel the Solution in accordance with its terms and conditions. With your permission, we may also share your personal information with AIIVA AUTOMATION PVT. LTD. business partners or vendors, so they may send you information about products or services that may be of interest to you. To opt-out of this sharing with third parties for their marketing purposes, click here.
</p>

<p className="mb-6">
  By using our websites, Solutions, or otherwise providing personal information to us, you agree that we may communicate with you electronically regarding security, privacy, and administrative issues relating to your use. For example, if we learn of a security system’s breach, we may attempt to notify you electronically by posting a notice on our websites, by sending an email, or otherwise contacting you through mobile.
</p>
...
<p className="mb-6">
  ...
  <ul className="pl-6 list-disc">
    <li>Within AIIVA AUTOMATION PVT. LTD. and its parent companies or subsidiaries for purposes of data processing or storage.</li>
    <li>With AIIVA AUTOMATION PVT. LTD. business partners or vendors, so that they may share information with you about their products or services. To opt-out of AIIVA AUTOMATION PVT. LTD. sharing with third parties for their marketing purposes, click here.</li>
    ...
    <li>In connection with, or during negotiations of, any merger, sale of company assets, consolidation or restructuring, financing, or acquisition of all or a portion of our business by or to another company.
        <br/>
        In response to a request for information by a competent authority if we believe disclosure is in accordance with, or is otherwise required by, any applicable law, regulation or legal process.
    </li>
    <li>With law enforcement officials, government authorities, or other third parties as necessary to comply with legal process or meet national security requirements; protect the rights, property, or safety of AIIVA AUTOMATION PVT. LTD., its business partners, you, or others; or as otherwise required by applicable law.</li>
...
<p className="mb-6">
  We intend to protect the personal information entrusted to us and treat it securely in accordance with this Privacy Statement. AIIVA AUTOMATION PVT. LTD. implements physical, administrative, and technical safeguards designed to protect your personal information from unauthorized access, use, or disclosure. We also contractually require that our suppliers protect such information from unauthorized access, use, and disclosure. The Internet, however, cannot be guaranteed to be 100% secure, and we cannot ensure or warrant the security of any personal information you provide to us.
</p>
...
<p className="mb-6">
  If you participate in a discussion forum, local communities, or chat room on a AIIVA AUTOMATION PVT. LTD. website, you should be aware that the information you provide there (i.e. your public profile) will be made broadly available to others, and could be used to contact you, send you unsolicited messages, or for purposes neither AIIVA AUTOMATION PVT. LTD. nor you have control over. Also, please recognize that individual forums and chat rooms may have additional rules and conditions. AIIVA AUTOMATION PVT. LTD. is not responsible for the personal information or any other information you choose to submit in these forums. To request removal of your personal information from our blog or community forum, contact us at aiivaautomation@gmail.com. In some cases, we may not be able to remove your personal information, in which case we will let you know if we are unable to do so and why.
</p>
...
<p className="mb-6">
  AIIVA AUTOMATION PVT. LTD. encourages parents and guardians to take an active role in their children’s online activities. AIIVA AUTOMATION PVT. LTD. does not knowingly collect personal information from children without appropriate parental or guardian consent. If you believe that we may have collected personal information from someone under the applicable age of consent in your country without proper consent, please let us know using the methods described in the Contact Us section and we will take appropriate measures to investigate and address the issue promptly.
</p>
...
<p className="mb-6">
  We value your opinions. Should you have questions or comments related to this Privacy Statement, please email our privacy team at aiivaautomation@gmail.com.
</p>

<p className="mb-6">
  Alternatively, write to: AIIVA AUTOMATION PRIVATE LIMITED, F-504 , The Legend , Basheer bagh , Hyderabad - 500063
</p>
